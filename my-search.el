...
(defvar *default-search-extensions*
  '(".el" ".java" ".html" ".txt" ".csv" ".xml" ".ftl" ".tex" ".py" ".sty" ".dtx" ".c" ".h" ".cpp" ".def" ".lisp" ".cls" ".ml" ".mli" ".rb" ".rhtml" ".rxml" ".js" ".hx" ".css" ".svg" ".drl" ".erb" ".md" ".haml" ".yml" ".treetop" ".scss" ".coffee" ".bracketup" ".corrml" ".idr" ".ipkg" ".brackdom")
