...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "idris-commands" '("def-region-" "idris-" "proof-region-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "idris-common-utils" '("destructure-case" "idris-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "idris-navigate" '("empty-line-p-chars" "idris-" "toplevel-nostart-chars")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "idris-repl" '("find-common-prefix" "idris-")))
...
If called interactively, enable Idris-Simple-Indent mode if ARG
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "idris-simple-indent" '("idris-simple-indent" "turn-off-idris-simple-indent")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "idris-test-utils" '("check-rest" "idris-")))
