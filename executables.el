...
;; Locations of various executables (do not edit values here, instead specify them somewhere else using setq)

(defvar *firefox-executable* nil "Firefox executable")
(defvar *external-text-editor* nil "External text editor")
